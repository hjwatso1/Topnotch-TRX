...
//@interface TopnotchTRXObject : NSObject
//@end

@interface TopnotchTRXObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TopnotchTRXObject class]])
		{
			for (NSString *key in [[(TopnotchTRXObject*)o modules] allKeys])
			{

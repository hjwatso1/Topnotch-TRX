...
// in simulator we redefine to format for TopnotchTRX Developer console
...
{\
	NSString * exceptionName = [@"org.topnotchtrx." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.topnotchtrx";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITopnotchTRXNativeItemNone = -1, 
	UITopnotchTRXNativeItemSpinner = -2,
	UITopnotchTRXNativeItemProgressBar = -3,
	
	UITopnotchTRXNativeItemSlider = -4,
	UITopnotchTRXNativeItemSwitch = -5,
	UITopnotchTRXNativeItemMultiButton = -6,
	UITopnotchTRXNativeItemSegmented = -7,
	
	UITopnotchTRXNativeItemTextView = -8,
	UITopnotchTRXNativeItemTextField = -9,
	UITopnotchTRXNativeItemSearchBar = -10,
	
	UITopnotchTRXNativeItemPicker = -11,
	UITopnotchTRXNativeItemDatePicker = -12,
	
	UITopnotchTRXNativeItemInfoLight = -13,
	UITopnotchTRXNativeItemInfoDark = -14,
	
	UITopnotchTRXNativeItemDisclosure = -15,
	
	UITopnotchTRXNativeItemContactAdd = -16
};
